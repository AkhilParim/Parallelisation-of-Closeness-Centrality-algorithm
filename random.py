...
print("graph formed with ", n_users, "nodes and ", n_relationships, "connections")

A = nx.adjacency_matrix(G).tolil()
D = scipy.sparse.csgraph.floyd_warshall( \
             A, directed=True, unweighted=True)
...
# print("Number of users: 4039")
# print("Number of connections: 88234")
